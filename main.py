...
def collision(bird, top_pipes, bottom_pipes):
    if bird.y >= HEIGHT - 1.5*FLOOR_HEIGHT:
        HIT_SOUND.play()
        return False
...
def main():
    ...
    bottom_pipes = []
    top_pipes_fake = []
    height = [300, 150, 150, 100, 100, 200, 180, 220, 330, 240, 230, 380, 280, 400, 350, 250, 450, 300, 200, 400, 350, 250, 450]
    score = 0 
